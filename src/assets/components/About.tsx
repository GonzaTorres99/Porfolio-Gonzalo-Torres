                ...
                <div className='order-2 md:order-1'>
                    <div className='my-auto'>
                        ...
                        <div className='space-y-4 text-lg'>
                            <p>
                                 ¡Hola! Soy <strong>Gonzalo Torres</strong>, finalicé la Diplomatura de Full Stack Developer realizada en la Universidad Tecnologica Nacional regional de Buenos Aires en agosto de 2024.
                            </p>
